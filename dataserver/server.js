...
app.get("/userachievement/:userID/:arcID", async (req, res) => {
  res.json(
    await db.UserAchievementGetByUserIDAndArcID(
      req.params.userID,
      req.params.arcID
    )
  );
...
app.post("/userachievement/:userID/:arcID", async (req, res) => {
  await db.UserAchievementUpdateLevel(
    req.params.userID,
    req.params.arcID,
    req.body
  );
...
app.get("/dungeonstat/sum/:userID/:dungeonID", async (req, res) => {
  res.json(
    await db.DungeonStatGetSumTotal(req.params.userID, req.params.dungeonID)
  );
});

app.get("/dungeonstat/:userID/:dungeonID/:difficulty", async (req, res) => {
  res.json(
    await db.DungeonStatGetProgress(
      req.params.userID,
